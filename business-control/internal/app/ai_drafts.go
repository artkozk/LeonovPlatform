...
func (s *Server) handleAIQuestionDraft(w http.ResponseWriter, r *http.Request) {
	...
	prompt := fmt.Sprintf(`Подготовь нейтральный черновик совместного решения двух сооснователей. Верни только JSON:
