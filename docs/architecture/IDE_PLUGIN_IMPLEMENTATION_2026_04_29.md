...
## 15. Update 2026-05-03 — compatible package for PyCharm 2024.2.6

1. На пользовательском окружении подтверждена IDE-ветка `242` (PyCharm `2024.2.6`).
2. Пакет, собранный под `251.*`, в этой IDE не активируется по build-range ограничениям.

3. Чтобы обеспечить установку именно в `2024.2.6`, build-конфигурация упакована с параметрами:
