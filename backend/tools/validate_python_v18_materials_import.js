...
const MIGRATION_PATH = path.resolve(__dirname, '../migrations/033_reseed_python_zero_v18_coursewide_diversity.sql');
const REPORT_PATH = path.resolve(__dirname, '../../docs/operations/PYTHON_V18_STRICT_PEDAGOGY_IMPORT_VALIDATION_2026_05_06_COURSEWIDE_DIVERSITY.md');
...
function main() {
  ...
  const reportLines = [
    '# Python v18 Strict Pedagogy Import Validation — 2026-05-06 Coursewide Diversity',
    '',
    '## Source Inputs',
