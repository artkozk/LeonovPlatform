...
const MIGRATION_PATH = path.resolve(__dirname, '../migrations/035_reseed_python_zero_v18_http_api_alignment.sql');
const REPORT_PATH = path.resolve(__dirname, '../../docs/operations/PYTHON_V18_STRICT_PEDAGOGY_IMPORT_VALIDATION_2026_05_06_HTTP_API_ALIGNMENT.md');
...
function main() {
  ...
  const reportLines = [
    '# Python v18 Strict Pedagogy Import Validation — 2026-05-06 HTTP API Alignment',
    '',
    '## Source Inputs',
