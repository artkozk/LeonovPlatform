...
const MIGRATION_PATH = path.resolve(__dirname, '../migrations/025_reseed_python_zero_v16_materials.sql');
const REPORT_PATH = path.resolve(__dirname, '../../docs/operations/PYTHON_V16_MATERIALS_IMPORT_VALIDATION_2026_05_03.md');
