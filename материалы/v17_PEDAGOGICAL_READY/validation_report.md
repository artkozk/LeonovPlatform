# Validation report v17_PEDAGOGICAL_READY
...
- total steps: 2567
- total hours: 1110.1
- steps by type: {'theory': 339, 'test': 378, 'practice': 1283, 'project': 398, 'summary': 169}
- checkers by type: {'none': 508, 'quiz_single': 378, 'python_stdout': 48, 'ide_plugin': 622, 'python_pytest': 475, 'sql_query': 287, 'http_api': 249}
- structured questions: 1134

## Quality gates
- duplicate body_markdown: 0 duplicates / 0 groups
...
- duplicate normalized practice/project body inside lessons: 0
- duplicate normalized practice/project solution inside lessons: 0
- duplicate semantic checker signatures inside lessons: 0
...
- FastAPI route/model/checker signature reuse: 0
...
- generic test questions without lesson terms: 0
- lesson_stage/content mismatches: 0
- complex theory steps below threshold: 0
- weak project solution_code: 0
- unique learning objectives: 1681
- lesson ladder stage gaps: 0
- lessons without mini-project: 0
- test steps with fewer than 3 questions: 0
- complex lessons below target step count: 0
- AI lessons with generic non-AI practice: 0
- empty practice solutions: 0
- empty project solutions: 0
- unique IDE signatures: 622
...
## Critical checks
- missing checkers: 0
- missing quiz questions: 0
- body leaks: 0
- banned text: 0
- duplicate ids: 0
- projects without IDE/AI review: 0
