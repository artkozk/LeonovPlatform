...
function humanAuthError(raw?: string) {
  ...
  if (text.includes("email must be a valid address")) return "Логин введён некорректно. Для входа используйте email (включая admin@platform.local) или username (admin).";
